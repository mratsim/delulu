//!  Delulu arXiv Paper Search — Test Fixtures
//!
...
/// Load the arXiv search response fixture XML.
pub fn arxiv_search_response() -> String {
    load_zst("arxiv-search-response.xml.zst")
}
